...
namespace MNPContactManagementWeb.ViewModels
{
    ...
    public class ContactDetailVM
    {
        ...
        [MinLength(2, ErrorMessage = "2- 100 characters"), MaxLength(100, ErrorMessage = "2 - 100 characters")]
        [Required(ErrorMessage = "Required")]
        [DisplayName("Name:")]
        public string ContactName { get; set; }

        [MinLength(2, ErrorMessage = "2- 200 characters"), MaxLength(200, ErrorMessage = "2 - 200 characters")]
        [DisplayName("Address:")]
        ...
        [MinLength(2, ErrorMessage = "2- 50 characters"), MaxLength(50, ErrorMessage = "2 - 50 characters")]
